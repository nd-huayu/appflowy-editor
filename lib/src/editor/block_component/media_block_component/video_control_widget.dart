...
///
/// {@endtemplate}
Widget DefaultDesktopVideoControls(VideoState state) {
...
///
/// Theming related data for [DefaultDesktopVideoControls]. These values are used to theme the descendant [DefaultDesktopVideoControls].
///
/// {@endtemplate}
